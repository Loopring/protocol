...
async function submit(p: LoopringSubmitParams) {
  ...
  const tx = await contractInstance.submitRing(p.uintArgsList,
                                               p.uint8ArgsList,
